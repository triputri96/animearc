    ...
    <div class="col-6 d-flex align-center">
      <div>
        <div class="mb-3">
          ...
          <p class="hero-description align-justify">Raja iblis telah dikalahkan, dan grup para pahlawan kembali ke rumah
            sebelum
...
<section class="ptb-4 mb-5">
  ...
  <!-- <div class="d-flex justify-content-between"> -->
    <div class="">
      <img src="assets/imgs/frieren.png" alt="" width="110" height="110" class="fit-cover chara-selection" onclick="selectImage(0)">
    </div>
    <div class="">
      <img src="assets/imgs/fern.png" alt="" width="110" height="110" class="fit-cover chara-selection" onclick="selectImage(1)">
    </div>
    <div class="">
      <img src="assets/imgs/stark.png" alt="" width="110" height="110" class="fit-cover chara-selection" onclick="selectImage(2)">
    </div>
      <!-- </div> -->
  </div>
</section>
